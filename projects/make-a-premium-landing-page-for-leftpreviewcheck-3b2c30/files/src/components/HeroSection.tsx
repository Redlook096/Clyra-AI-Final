...
export function HeroSection() {
  return (
    <header className="hero-shell" id="top">
      <nav className="nav">
        <a className="brand" href="#top" aria-label="LeftPreviewCheck home">
          <span className="brand-mark">L</span>
          <span>LeftPreviewCheck</span>
        </a>
      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <p className="hero-lead">
            LeftPreviewCheck gives developers a premium vibe coding workspace with deep Plan Mode, one-file-at-a-time generation, live preview, terminal checks, and controlled final review.
          </p>
