...
Plan revision request: make the calculator focused only on the calculator, with no marketing sections
...
- Responsive behaviour: a centered calculator surface on desktop and mobile, without landing-page marketing sections.

## 3. Feature Completeness Checklist

- Working calculator logic.
- Keyboard support for digits, operators, enter, escape, and backspace.
- Compact in-calculator recent calculation history.
