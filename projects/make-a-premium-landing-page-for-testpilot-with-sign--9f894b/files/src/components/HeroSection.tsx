...
export function HeroSection() {
  return (
    <header className="hero-shell" id="top">
      <nav className="nav">
        <a className="brand" href="#top" aria-label="TestPilot home">
      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <p className="hero-lead">
            TestPilot gives developers a premium vibe coding workspace with deep Plan Mode, one-file-at-a-time generation, live preview, terminal checks, and controlled final review.
          </p>
