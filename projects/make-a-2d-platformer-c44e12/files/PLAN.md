...
This classification fits because the latest request is: make a 2d platformer

---

## 2. Goal

Build a complete interactive game for: make a 2d platformer.
...
- Explicit request: make a 2d platformer
...
- Path: `index.html`
  ...
  - Main contents: focused implementation for interactive game.
...
### Step 1 — Define game loop, controls, and level scope
...
- Confirm this request is being built literally as interactive game.
...
### Step 2 — Build the playable canvas and scene shell
...
### Step 3 — Implement player movement, collisions, and scoring
...
### Step 4 — Add menus, feedback, and restart flow
...
### Step 5 — Polish motion, responsiveness, and visual depth
...
### Step 6 — Validate gameplay and preview
