  ...
  return (
    <main className="page">
      <section className="intro">
        <span className="eyebrow">Premium utility</span>
        <h1>A calm calculator that feels fast, focused, and polished.</h1>
        <p>Use buttons or keyboard shortcuts. Every interaction is local, instant, and built for a clean desktop or mobile preview.</p>
      </section>
