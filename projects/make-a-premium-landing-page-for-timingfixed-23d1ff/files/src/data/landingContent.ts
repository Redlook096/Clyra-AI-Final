...
export const features = [
  {
    ...
    copy: "TimingFixed turns messy requests into a structured PLAN.md with file targets, task dependencies, checks, and rollback points.",
  },
  {
...
export const faqs = [
  ["What is TimingFixed?", "TimingFixed is an AI coding platform that plans, writes files, runs checks, previews the app, fixes errors, and keeps project state saved."],
