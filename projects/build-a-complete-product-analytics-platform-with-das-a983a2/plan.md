# Plan: Build a complete product analytics platform with dashboards, funnels, cohorts, a

## 1. Goal

Build a complete, presentable implementation for **Build a complete product analytics platform with dashboards, funnels, cohorts, a**.
...
- Direct request: Build a complete product analytics platform with dashboards, funnels, cohorts, alerts, billing settings, onboarding, empty states, and responsive views
