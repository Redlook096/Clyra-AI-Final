    ...
    <section className="section product-preview" id="product">
      <div className="workspace-mock">
        <aside className="mock-chat">
          ...
          <div className="thinking-line"><span /> FlowPilot is mapping the existing project before writing PLAN.md.</div>
        ...
        <main className="mock-main">
          ...
          <div className="terminal">$ npm run build<br />✓ built in 1.42s<br />Track ready at localhost</div>
        </main>
      </div>
    </section>
  );
