...
- Routing: single React app surface with tab state; Vibe Assignr is rendered as a tab inside the existing Clyra shell.
- Component structure: Vibe Assignr uses `VibeAssignrWorkspace`, `ThinkingStatus`, `MiniAssignBoxQueue`, `FileTreePanel`, `PlanPanel`, `TerminalPanel`, and `LiveTrackPanel`.
...
- Planning section: project plan preview, structured steps, architecture planning, file queue, and validation checklist.
- Assign generation section: one-file-at-a-time workflow from plan to file generation, checks, fixes, and preview.
...
| --- | --- | --- | --- | --- |
| package.json | Track project metadata and scripts | dev/build/preview scripts | Vite preview runner | Vite build reads scripts |
...
| src/components/ProductTrack.tsx | Workspace mock preview | ProductTrack | CSS | visual preview |
| src/components/PlanModeSection.tsx | project plan/steps visual | PlanModeSection | landingContent | visual preview |
| src/components/AssignGenerationSection.tsx | One-file workflow | AssignGenerationSection | landingContent | visual preview |
| src/components/LiveTrackSection.tsx | Track/device mock | LiveTrackSection | CSS | visual preview |
| src/components/FeatureGrid.tsx | Feature cards | FeatureGrid | landingContent | responsive preview |
| src/components/WorkflowSection.tsx | Plan to ship process | WorkflowSection | landingContent | responsive preview |
...
1. Create and save this project plan as the source of truth.
...
- project plan exists and was created before implementation files.
